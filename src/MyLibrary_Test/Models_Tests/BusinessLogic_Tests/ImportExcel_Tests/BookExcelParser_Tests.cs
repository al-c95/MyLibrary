...
namespace MyLibrary_Test.Models_Tests.BusinessLogic_Tests.ImportExcel_Tests
{
    ...
    class BookExcelParser_Tests
    {
        ...
        public void Run_Test()
        {
            ...
            AddRow(pck, "F7", "John Smith; Jane Doe");
            ...
            // invalid pages
            AddRow(pck, "A17", null);
            AddRow(pck, "B17", "item1");
            AddRow(pck, "C17", "item1: this is a test");
            AddRow(pck, "D17", "0123456789");
            AddRow(pck, "E17", "0123456789012");
            AddRow(pck, "F17", "John Smith; Jane Doe");
            AddRow(pck, "G17", "English");
            AddRow(pck, "H17", "tag1, tag2");
            AddRow(pck, "I17", "1.20");
            AddRow(pck, "J17", "msrp");
            AddRow(pck, "K17", "some_publisher");
            AddRow(pck, "L17", "format");
            AddRow(pck, "M17", "2010");
            AddRow(pck, "N17", "Australia");
            AddRow(pck, "O17", "First Edition");
            AddRow(pck, "P17", "bogus");
            AddRow(pck, "Q17", "dimensions");
            AddRow(pck, "R17", "overview");
            AddRow(pck, "S17", "excerpt");
            AddRow(pck, "T17", "synopsys");
            AddRow(pck, "U17", "this is a test.");
            // service
            ...
            Assert.IsTrue(results.Any(r => r.Status == ExcelRowResultStatus.Success &&
                                            ...
                                            ((Book)r.Item).Authors.Any(a => a.FirstName.Equals("John") && a.LastName.Equals("Smith")) &&
            ...
            Assert.IsTrue(results.Any(r => r.Status == ExcelRowResultStatus.Success &&
                                            ...
                                            ((Book)r.Item).Authors.Any(a => a.FirstName == "John" && a.LastName == "Smith") &&
                                            ((Book)r.Item).Language == "English" &&
